...
public class EnemyPatrolState : EnemyBaseState
{
    ...
    IEnumerator PatrolLook(EnemyStateManager enemy, float lookLength = 3f, float lookRadius = 179f)
    {
        ...
        //this can be severely cut down with either a method or a more effici ent translation
        enemy.StartCoroutine(Look(enemy, firstLook, lookRadius));
        yield return new WaitForSeconds(5);
        enemy.StartCoroutine(Look(enemy, secondLook, -lookRadius * 2));
    ...
    IEnumerator Look(EnemyStateManager enemy, float turnLength = 3f, float lookRadius = 179f, float lookLength = 1)
    {
        //first look
